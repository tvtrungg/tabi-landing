...
function Romantic() {
  ...
  return (
    <div className="bg-bling">
      <div
        className="h-full py-16 relative xs:max-w-screen-xs 2xs:max-w-screen-2xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto"
        id="romantic"
      >
